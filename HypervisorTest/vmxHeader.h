...
#define CPU_BASED_VIRTUAL_INTR_PENDING        0x00000004 // the bit number 2 is set (starting from bit number 0)
...
// this happens when the guest exit and give the control back to the host..
...
typedef union _HV_SEGMENT_ATTRIBUTES
{
    USHORT UCHARs;
    struct
    {
...
} HV_SEGMENT_ATTRIBUTES, *PHV_SEGMENT_ATTRIBUTES;


typedef struct _HV_SEGMENT_SELECTOR
{
    USHORT             SEL;
    HV_SEGMENT_ATTRIBUTES ATTRIBUTES;
    ULONG32            LIMIT;
    ULONG64            BASE;
} HV_SEGMENT_SELECTOR, *PHV_SEGMENT_SELECTOR;

typedef struct _HV_SEGMENT_DESCRIPTOR
{
    USHORT LIMIT0;
    USHORT BASE0;
    UCHAR  BASE1;
    ...
    UCHAR  LIMIT1ATTR1;
    UCHAR  BASE2;
} HV_SEGMENT_DESCRIPTOR, * PHV_SEGMENT_DESCRIPTOR;
...
BOOLEAN HvLaunchVm(_In_ int NumOfCores);
